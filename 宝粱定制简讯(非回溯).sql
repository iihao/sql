...
RG AS (
	SELECT 
		ProjGUID,
		SUM(CASE WHEN QSDate = @now  THEN ts ELSE 0 END) AS 本日认购套数 ,
		SUM(CASE WHEN QSDate = @now  THEN BldArea ELSE 0 END) AS 本日认购面积 ,
		SUM(CASE WHEN QSDate = @now  THEN OCjTotal ELSE 0 END)/10000  AS 本日认购金额 ,
		SUM(CASE WHEN QSDate = @now and a.TopProductTypeName='住宅'  THEN ts ELSE 0 END) AS 本日住宅认购套数 ,
		SUM(CASE WHEN QSDate = @now and a.TopProductTypeName='住宅'  THEN BldArea ELSE 0 END) AS 本日住宅认购面积 ,
		SUM(CASE WHEN QSDate = @now and a.TopProductTypeName='住宅'  THEN OCJTotal ELSE 0 END)/10000  AS 本日住宅认购金额 ,
		SUM(CASE WHEN QSDate = @now and a.TopProductTypeName='商业'  THEN ts ELSE 0 END) AS 本日商业认购套数 ,
		SUM(CASE WHEN QSDate = @now and a.TopProductTypeName='商业'  THEN BldArea ELSE 0 END) AS 本日商业认购面积 ,
		SUM(CASE WHEN QSDate = @now and a.TopProductTypeName='商业'  THEN OCJTotal ELSE 0 END)/10000  AS 本日商业认购金额 ,
		SUM(CASE WHEN QSDate = @now and a.TopProductTypeName='车库/库房'  THEN ts ELSE 0 END) AS 本日车位认购套数 ,
		SUM(CASE WHEN QSDate = @now and a.TopProductTypeName='车库/库房'  THEN BldArea ELSE 0 END) AS 本日车位认购面积 ,
		SUM(CASE WHEN QSDate = @now and a.TopProductTypeName='车库/库房'  THEN OCJTotal ELSE 0 END)/10000  AS 本日车位认购金额 ,
		...
		SUM(CASE WHEN QSDate BETWEEN @weekstartday AND @weekendday  THEN ts ELSE 0 END) AS 本周认购套数 ,
		SUM(CASE WHEN QSDate BETWEEN @weekstartday AND @weekendday  THEN BldArea ELSE 0 END) AS 本周认购面积 ,
		SUM(CASE WHEN QSDate BETWEEN @weekstartday AND @weekendday  THEN OCJTotal ELSE 0 END)/10000  AS 本周认购金额 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  THEN ts ELSE 0 END) AS 本月认购套数 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  THEN BldArea ELSE 0 END) AS 本月认购面积 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  THEN OCJTotal ELSE 0 END)/10000  AS 本月认购金额 ,
		SUM(CASE WHEN QSDate BETWEEN @yearstartday AND @yearendday  THEN ts ELSE 0 END) AS 本年认购套数 ,
		SUM(CASE WHEN QSDate BETWEEN @yearstartday AND @yearendday  THEN BldArea ELSE 0 END) AS 本年认购面积 ,
		SUM(CASE WHEN QSDate BETWEEN @yearstartday AND @yearendday  THEN OCJTotal ELSE 0 END)/10000  AS 本年认购金额 ,
...
WS AS (
	...
	SUM(case when Status in ('销控','待售') then Total else 0 end) as 未售金额,
	SUM(case when Status in ('销控','待售') and r.TopProductTypeName='住宅' then 1 else 0 end) as 住宅未售套数,
	SUM(case when Status in ('销控','待售') and r.TopProductTypeName='住宅' then Total else 0 end) as 住宅未售金额,
	SUM(case when Status in ('销控','待售') and r.TopProductTypeName='商业' then 1 else 0 end) as 商业未售套数,
	SUM(case when Status in ('销控','待售') and r.TopProductTypeName='商业' then Total else 0 end) as 商业未售金额,
	SUM(case when Status in ('销控','待售') and r.TopProductTypeName='车位' then 1 else 0 end) as 车位未售套数,
	SUM(case when Status in ('销控','待售') and r.TopProductTypeName='车位' then Total else 0 end) as 车位未售金额,

	SUM(t.YsDkFk-t.Ssdkfk) as 贷款类未收,
	SUM(t.YsFdkFk-t.Ssfdkfk) as 非贷款类未收,
	SUM(case when t.TopProductTypeName='住宅' then t.YsDkFk-t.Ssdkfk else 0 end) as 住宅贷款类未收,
	SUM(case when t.TopProductTypeName='住宅' then t.YsFdkFk-t.Ssfdkfk else 0 end) as 住宅非贷款类未收,
	SUM(case when t.TopProductTypeName='商业' then t.YsDkFk-t.Ssdkfk else 0 end) as 商业贷款类未收,
	SUM(case when t.TopProductTypeName='商业' then t.YsFdkFk-t.Ssfdkfk else 0 end) as 商业非贷款类未收,
	SUM(case when t.TopProductTypeName='车位' then t.YsDkFk-t.Ssdkfk else 0 end) as 车位贷款类未收,
	SUM(case when t.TopProductTypeName='车位' then t.YsFdkFk-t.Ssfdkfk else 0 end) as 车位非贷款类未收
