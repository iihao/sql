...
QY AS (
	SELECT 
		ProjGUID,
		SUM(CASE WHEN QSDate = @now  THEN ts ELSE 0 END) AS 本日签约套数 ,
		SUM(CASE WHEN QSDate = @now  THEN BldArea ELSE 0 END) AS 本日签约面积 ,
		SUM(CASE WHEN QSDate = @now  THEN RmbAmount ELSE 0 END)/10000 AS 本日签约金额 ,
	
		SUM(CASE WHEN QSDate = @now AND a.TopProductTypeName='住宅'  THEN ts ELSE 0 END) AS 本日住宅签约套数 ,
		SUM(CASE WHEN QSDate = @now AND a.TopProductTypeName='住宅'  THEN BldArea ELSE 0 END) AS 本日住宅签约面积 ,
		SUM(CASE WHEN QSDate = @now AND a.TopProductTypeName='住宅' THEN RmbAmount ELSE 0 END)/10000 AS 本日住宅签约金额 ,
		
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  AND a.TopProductTypeName='住宅'  THEN ts ELSE 0 END) AS 本月住宅签约套数 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday AND a.TopProductTypeName='住宅'  THEN BldArea ELSE 0 END) AS 本月住宅签约面积 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  AND a.TopProductTypeName='住宅' 	THEN RmbAmount ELSE 0 END)/10000 AS 本月住宅签约金额 ,	
		...
		SUM(CASE WHEN QSDate = @now AND a.TopProductTypeName='商业'  THEN ts ELSE 0 END) AS 本日商业签约套数 ,
		SUM(CASE WHEN QSDate = @now AND a.TopProductTypeName='商业'  THEN ts ELSE 0 END) AS 本日商业签约面积 ,
		SUM(CASE WHEN QSDate = @now AND a.TopProductTypeName='商业' THEN RmbAmount ELSE 0 END)/10000 AS 本日商业签约金额 ,
		
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  AND a.TopProductTypeName='商业'  THEN ts ELSE 0 END) AS 本月商业签约套数 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday AND a.TopProductTypeName='商业'  THEN BldArea ELSE 0 END) AS 本月商业签约面积 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  AND a.TopProductTypeName='商业' 	THEN RmbAmount ELSE 0 END)/10000 AS 本月商业签约金额 ,	
		...
		SUM(CASE WHEN QSDate = @now AND a.TopProductTypeName='车库/库房'  THEN ts ELSE 0 END) AS 本日车位签约套数 ,
		SUM(CASE WHEN QSDate = @now AND a.TopProductTypeName='车库/库房'  THEN ts ELSE 0 END) AS 本日车位签约面积 ,
		SUM(CASE WHEN QSDate = @now AND a.TopProductTypeName='车库/库房' THEN RmbAmount ELSE 0 END)/10000 AS 本日车位签约金额 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  AND a.TopProductTypeName='车库/库房'  THEN ts ELSE 0 END) AS 本月车位签约套数 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday AND a.TopProductTypeName='车库/库房'  THEN BldArea ELSE 0 END) AS 本月车位签约面积 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  AND a.TopProductTypeName='车库/库房' 	THEN RmbAmount ELSE 0 END)/10000 AS 本月车位签约金额 ,	
		...
		---------
		SUM(CASE WHEN QSDate BETWEEN @weekstartday AND @weekendday  THEN ts ELSE 0 END) AS 本周签约套数 ,
		SUM(CASE WHEN QSDate BETWEEN @weekstartday AND @weekendday  THEN BldArea ELSE 0 END) AS 本周签约面积 ,
		SUM(CASE WHEN QSDate BETWEEN @weekstartday AND @weekendday  THEN RmbAmount ELSE 0 END)/10000  AS 本周签约金额 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  THEN ts ELSE 0 END) AS 本月签约套数 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  THEN BldArea ELSE 0 END) AS 本月签约面积 ,
		SUM(CASE WHEN QSDate BETWEEN @monthstartday AND @monthendday  THEN RmbAmount ELSE 0 END)/10000  AS 本月签约金额 ,
		SUM(CASE WHEN QSDate BETWEEN @yearstartday AND @yearendday  THEN ts ELSE 0 END) AS 本年签约套数 ,
		SUM(CASE WHEN QSDate BETWEEN @yearstartday AND @yearendday  THEN BldArea ELSE 0 END) AS 本年签约面积 ,
		SUM(CASE WHEN QSDate BETWEEN @yearstartday AND @yearendday  THEN RmbAmount ELSE 0 END)/10000  AS 本年签约金额 ,
...
SELECT 
		ProjGUID,
		SUM(CASE WHEN t.OQSDate = @now  THEN ts ELSE 0 END) AS 本日认购套数 ,
		SUM(CASE WHEN t.OQSDate = @now  THEN BldArea ELSE 0 END) AS 本日认购面积 ,
		SUM(CASE WHEN t.OQSDate = @now  THEN OCjTotal ELSE 0 END)/10000  AS 本日认购金额 ,
		SUM(CASE WHEN t.OQSDate = @now and a.TopProductTypeName='住宅'  THEN ts ELSE 0 END) AS 本日住宅认购套数 ,
		SUM(CASE WHEN t.OQSDate = @now and a.TopProductTypeName='住宅'  THEN BldArea ELSE 0 END) AS 本日住宅认购面积 ,
		SUM(CASE WHEN t.OQSDate = @now and a.TopProductTypeName='住宅'  THEN OCJTotal ELSE 0 END)/10000  AS 本日住宅认购金额 ,
		SUM(CASE WHEN t.OQSDate = @now and a.TopProductTypeName='商业'  THEN ts ELSE 0 END) AS 本日商业认购套数 ,
		SUM(CASE WHEN t.OQSDate = @now and a.TopProductTypeName='商业'  THEN BldArea ELSE 0 END) AS 本日商业认购面积 ,
		SUM(CASE WHEN t.OQSDate = @now and a.TopProductTypeName='商业'  THEN OCJTotal ELSE 0 END)/10000  AS 本日商业认购金额 ,
		SUM(CASE WHEN t.OQSDate = @now and a.TopProductTypeName='车库/库房'  THEN ts ELSE 0 END) AS 本日车位认购套数 ,
		SUM(CASE WHEN t.OQSDate = @now and a.TopProductTypeName='车库/库房'  THEN BldArea ELSE 0 END) AS 本日车位认购面积 ,
		SUM(CASE WHEN t.OQSDate = @now and a.TopProductTypeName='车库/库房'  THEN OCJTotal ELSE 0 END)/10000  AS 本日车位认购金额 ,
		
		SUM(CASE WHEN t.OQSDate  BETWEEN @monthstartday AND @monthendday  and a.TopProductTypeName='住宅'  THEN ts ELSE 0 END) AS 本月住宅认购套数 ,
		SUM(CASE WHEN t.OQSDate  BETWEEN @monthstartday AND @monthendday  and a.TopProductTypeName='住宅'  THEN BldArea ELSE 0 END) AS 本月住宅认购面积 ,
		SUM(CASE WHEN t.OQSDate  BETWEEN @monthstartday AND @monthendday  and a.TopProductTypeName='住宅'  THEN OCJTotal ELSE 0 END)/10000  AS 本月住宅认购金额 ,
		SUM(CASE WHEN t.OQSDate  BETWEEN @monthstartday AND @monthendday  and a.TopProductTypeName='商业'  THEN ts ELSE 0 END) AS 本月商业认购套数 ,
		SUM(CASE WHEN t.OQSDate  BETWEEN @monthstartday AND @monthendday  and a.TopProductTypeName='商业'  THEN BldArea ELSE 0 END) AS 本月商业认购面积 ,
		SUM(CASE WHEN t.OQSDate  BETWEEN @monthstartday AND @monthendday  and a.TopProductTypeName='商业'  THEN OCJTotal ELSE 0 END)/10000  AS 本月商业认购金额 ,
		SUM(CASE WHEN t.OQSDate  BETWEEN @monthstartday AND @monthendday  and a.TopProductTypeName='车库/库房'  THEN ts ELSE 0 END) AS 本月车位认购套数 ,
		SUM(CASE WHEN t.OQSDate  BETWEEN @monthstartday AND @monthendday  and a.TopProductTypeName='车库/库房'  THEN BldArea ELSE 0 END) AS 本月车位认购面积 ,
		SUM(CASE WHEN t.OQSDate  BETWEEN @monthstartday AND @monthendday  
			year()=year(getdate()) and month()=month() 
			
			and a.TopProductTypeName='车库/库房'  THEN OCJTotal ELSE 0 END)/10000  AS 本月车位认购金额 ,
		...
		SUM(CASE WHEN t.OQSDate BETWEEN @weekstartday AND @weekendday  THEN ts ELSE 0 END) AS 本周认购套数 ,
		SUM(CASE WHEN t.OQSDate BETWEEN @weekstartday AND @weekendday  THEN BldArea ELSE 0 END) AS 本周认购面积 ,
		SUM(CASE WHEN t.OQSDate BETWEEN @weekstartday AND @weekendday  THEN OCJTotal ELSE 0 END)/10000  AS 本周认购金额 ,
		SUM(CASE WHEN t.OQSDate BETWEEN @monthstartday AND @monthendday  THEN ts ELSE 0 END) AS 本月认购套数 ,
		SUM(CASE WHEN t.OQSDate BETWEEN @monthstartday AND @monthendday  THEN BldArea ELSE 0 END) AS 本月认购面积 ,
		SUM(CASE WHEN t.OQSDate BETWEEN @monthstartday AND @monthendday  THEN OCJTotal ELSE 0 END)/10000  AS 本月认购金额 ,
		SUM(CASE WHEN t.OQSDate BETWEEN @yearstartday AND @yearendday  THEN ts ELSE 0 END) AS 本年认购套数 ,
		SUM(CASE WHEN t.OQSDate BETWEEN @yearstartday AND @yearendday  THEN BldArea ELSE 0 END) AS 本年认购面积 ,
		SUM(CASE WHEN t.OQSDate BETWEEN @yearstartday AND @yearendday  THEN OCJTotal ELSE 0 END)/10000  AS 本年认购金额 ,
	...
	FROM dbo.data_wide_s_SaleHsData A  WITH (NOLOCK) 
	left join (select TradeGUID,OQSDate from dbo.data_wide_s_Trade where OStatus='激活' or CStatus='激活') t 
	on a.TradeGUID=t.TradeGUID
	WHERE  TradeType IN ('签约', '认购','小订') 
	GROUP BY
		ProjGUID
),
HK AS (
