...
RG AS (
	SELECT 
		...
		SUM(CASE WHEN HsTjDate = @now and T.TopProductTypeName='车库/库房'  THEN RoomTotal ELSE 0 END)/10000  AS 本日车位认购金额 ,
		...
		SUM(CASE WHEN   T.TopProductTypeName='车库/库房'  THEN RoomTotal ELSE 0 END)/10000  AS 累计车位认购金额 ,
